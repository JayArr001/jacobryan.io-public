const PrivacyPolicyPage = () => {
  return (
    ...
    <div className="p-8 max-w-[80ch]">
        <h1 className="text-3xl font-bold">Privacy Policy</h1>
        <br/>
<p className="italic">Last updated: April 30, 2026</p>
<br/>
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to jacobryan.io.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to jacobryan.io, accessible from <a href="https://jacobryan.io" target="_blank">https://jacobryan.io</a>.</p>
</li>
<li>
...
<ul className="[&>*]:list-disc [&>*]:mx-4 [&>*]:pl-2">
<li>By email: jryan5685@gmail.com</li>
</ul>
    </div>
    </div>
  );
